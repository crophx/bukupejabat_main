      ...
      <div className="sticky top-8">
        <div className="bg-white rounded-2xl p-4 shadow-md border border-slate-100 h-full">
          ...
          <nav className="space-y-1">
            <NavLink
              to="/dashboard"
              className={({ isActive }) => `relative w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 ${isActive ? 'bg-slate-200' : ''}`}
            >
              {({ isActive }) => (
                <>
            ...
            >
              ...
              <span className="h-5 w-5 bg-slate-100 rounded-sm flex items-center justify-center text-slate-600">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-slate-700">Tambah Pegawai</span>
                </>
              )}
            </NavLink>
