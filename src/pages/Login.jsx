        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
          <div className="px-8 py-10">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-12 w-12 rounded-xl bg-sky-500 flex items-center justify-center text-white font-bold text-lg">A</div>
              <div>
                <h1 className="text-2xl font-extrabold text-slate-900">Buku Pejabat</h1>
            ...
            >
                  ...
                  >
                    {show ? (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0 1 12 19c-4.477 0-8.268-2.943-9.542-7a10.05 10.05 0 0 1 1.66-3.149M6.21 6.21 3 3m18 18-3.21-3.21" />
                      </svg>
                    ) : (
              ...
              <div className="flex items-center justify-between">
                <label className="inline-flex items-center gap-2 text-sm">
                  <input type="checkbox" defaultChecked className="checkbox text-slate-500" /><p className="text-slate-400">Remember me</p>
                </label>
            ...
            <div className="mt-6 text-center text-sm text-slate-500">
              Don’t have an account? <a href="#" className="text-sky-600 font-medium hover:underline">Sign up</a>
            </div>
          </div>

          <div className="px-8 py-4 bg-slate-50 border-t border-slate-100 text-xs text-slate-500 text-center">
            Property of Kementerian Luar Negeri - Biro Sumber Daya Manusia
          </div>
        </div>
      </div>
    </div>
