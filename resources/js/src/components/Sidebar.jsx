                        ...
                        <nav className="space-y-1 overflow-y-auto pr-1">
                            ...
                            >
                                {({ isActive }) => (
                                    <>
                                        <span
                                            className={`absolute left-0 top-0 bottom-0 w-1 rounded-r bg-sky-500 transition-opacity ${isActive ? "opacity-100" : "opacity-0"}`}
                                        />
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                                        className={`size-4 text-slate-400 transition-transform ${isUnitOpen ? "rotate-180" : ""}`}
                                    >
                                        <path
                                            fillRule="evenodd"
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                                        className={`size-4 text-slate-400 transition-transform ${isSettingsOpen ? "rotate-180" : ""}`}
                                    >
                                        <path
                                            fillRule="evenodd"
                                            d="M5.22 8.22a.75.75 0 011.06 0L10 11.94l3.72-3.72a.75.75 0 111.06 1.06l-4.25 4.25a.75.75 0 01-1.06 0L5.22 9.28a.75.75 0 010-1.06z"
                                ...
                                {isSettingsOpen && (
                                    <div className="mt-1 ml-4 pl-4 border-l border-slate-200 space-y-1 animate-in slide-in-from-top-1">
                                        <NavLink
                                            ...
                                            onClick={handleMobileClose}
                                            className={({ isActive }) =>
                                                `block px-3 py-2 text-xs font-medium rounded-lg transition-colors ${isActive
                                        ...
                                        className="w-full text-left px-3 py-2 text-xs font-medium text-rose-500 rounded-lg hover:bg-rose-50 transition-colors cursor-pointer"
                                    >
                                        Sign Out
                                    </button> */}
                                    </div>
