...
export default function PublicPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
            <div className="max-w-4xl w-full bg-white rounded-[32px] shadow-2xl shadow-slate-200/60 p-10 border border-slate-100 text-center">
                {/* Header Section */}
                <div className="mb-12">
                    ...
                    <p className="text-slate-500 font-medium">Akses data pegawai dan unduh laporan resmi per wilayah</p>
                </div>
